--edit of paintutils API to support my own render stuff
...
local function drawPixelInternal(xPos, yPos, lightLevel, Grid)
    if term.getGraphicsMode and term.getGraphicsMode() then
        Grid.setLightLevel(xPos, yPos,lightLevel)
    else
